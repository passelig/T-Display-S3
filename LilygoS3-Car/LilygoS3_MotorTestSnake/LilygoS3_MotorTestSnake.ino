...
void loop() {
  analogWrite(pwmENAPin, pwmSpeedHigh); // 255 = full speed
  analogWrite(pwmENBPin, pwmSpeedLow); // 255 = full speed
  rightMotorForward();
  leftMotorForward();
  delay(delayTime);

  analogWrite(pwmENAPin,pwmSpeedLow); // 255 = full speed
  analogWrite(pwmENBPin, pwmSpeedHigh); // 255 = full speed
  delay(delayTime);
